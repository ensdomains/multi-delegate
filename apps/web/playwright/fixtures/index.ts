...
const tenderly = defineChain({
  ...
  rpcUrls: {
    default: {
      http: [
        'https://virtual.mainnet.rpc.tenderly.co/48ec5f62-6920-4592-83c9-d67a40291c3b',
      ],
    },
  },
  blockExplorers: {
    default: {
      name: 'Explorer',
      url: 'https://virtual.mainnet.rpc.tenderly.co/48ec5f62-6920-4592-83c9-d67a40291c3b',
    },
  },
  contracts: {
